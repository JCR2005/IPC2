 ...
 */
@Path("ReporteComentarios")
public class RestReporteComentarios {

    private respuestaReporteComentarios respuesta = new respuestaReporteComentarios();
    private ConfiguracionReporteComentarios configuracionReporteComentarios = new ConfiguracionReporteComentarios();
