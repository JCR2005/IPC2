...
public class ReporteTop5EJasperReport implements JRDataSource {
   ...
   private List<String> idsRevistas = new ArrayList();
    ...
    private  List<List<MeGusta>> listaDatos = new ArrayList<>();  // Cambia a List<Comentario>
    ...
    public ReporteTop5EJasperReport(List<List<MeGusta>> comentariosFiltrados, List<String> titulos) {
  idsRevistas=titulos;
    ...
    public ReporteTop5EJasperReport(){}
...
public Object getFieldValue(JRField jrField) throws JRException {
    ...
    if (index < listaDatos.size()) {
        ...
        List<MeGusta> comentarios = listaDatos.get(index);  // Lista de comentarios para esa revista
    
        // Verifica si hay un comentario válido para el subIndex actual
        MeGusta comentarioActual = (subIndex < comentarios.size()) ? comentarios.get(subIndex) : null;
        ...
        switch (fieldName) {
            ...
            case "idMeGusta":
                return comentarioActual != null ? comentarioActual.getIdMeGusta(): null;
    ...
    public  JRDataSource getDataSource(List<List<MeGusta>> comentariosFiltrados, List<String> titulos) {
        return new ReporteTop5EJasperReport(comentariosFiltrados,titulos);
    }
}
